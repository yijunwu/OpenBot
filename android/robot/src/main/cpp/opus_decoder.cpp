...
Java_org_openbot_OpusDecoder_nativeInitDecoder(JNIEnv *env, jobject thiz,
...
Java_org_openbot_OpusDecoder_nativeDecodeBytes(JNIEnv *env, jobject thiz,
...
Java_org_openbot_OpusDecoder_nativeReleaseDecoder(JNIEnv *env, jobject thiz,
                                                           jlong decoder_handle) {
    OpusDecoder *decoder = (OpusDecoder*)(intptr_t)decoder_handle;
    if (decoder != nullptr) {
