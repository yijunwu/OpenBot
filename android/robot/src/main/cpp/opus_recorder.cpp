...
Java_org_openbot_OpusEncoder_nativeInitEncoder(JNIEnv *env, jobject thiz,
...
Java_org_openbot_OpusEncoder_nativeEncodeBytes(JNIEnv *env, jobject thiz,
...
Java_org_openbot_OpusEncoder_nativeReleaseEncoder(JNIEnv *env, jobject thiz,
                                                           jlong encoder_handle) {
    OpusEncoder *encoder = (OpusEncoder *) (intptr_t) encoder_handle;
    if (encoder != nullptr) {
