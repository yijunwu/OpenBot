...
public class RobotController {
    ...
    final double TARGET_DISTANCE = 0.55; // 0.4 // 期望保持的距离，单位：米
    ...
    // 车辆距离PID增益
    final double KP_D = 0.4; //0.4; //0.8;
    final double KI_D = 0.0;
    final double KD_D = 0.04; //0.0;
    ...
    // 舵机角度PID增益
    final double KP_SA = 0.9; //0.20; //0.25;
    final double KI_SA = 0.0;
    final double KD_SA = 0.09; //0.06; //0.05;
