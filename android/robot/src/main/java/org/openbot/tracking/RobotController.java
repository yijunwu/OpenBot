...
public class RobotController {
    ...
    // 车辆距离PID增益
    final double KP_D = 0.5; //0.4; //0.8;
    final double KI_D = 0.03;
    final double KD_D = 0.06; //0.0;

    // 车辆角度PID增益
    final double KP_A = 10; //10; //1.25;
    final double KI_A = 0.05;
    final double KD_A = 1.0; //0.0;

    // 舵机角度PID增益
    final double KP_SA = 0.25; //0.20; //0.25;
    final double KI_SA = 0.0125;
    final double KD_SA = 0.025; //0.06; //0.05;
