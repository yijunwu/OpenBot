...
public class RobotController {
    ...
    final double TARGET_DISTANCE = 0.5; // 0.4 // 期望保持的距离，单位：米
    ...
    // 车辆距离PID增益
    final double KP_D = 0.8; //0.4; //0.8;
    final double KI_D = 0.0;
    final double KD_D = 0.08; //0.0;

    // 车辆角度PID增益
    final double KP_A = 15; //10; //1.25;
    final double KI_A = 0.0;
    final double KD_A = 1.5; //0.0;

    // 舵机角度PID增益
    final double KP_SA = 0.20; //0.20; //0.25;
    final double KI_SA = 0.0;
    final double KD_SA = 0.07; //0.06; //0.05;
